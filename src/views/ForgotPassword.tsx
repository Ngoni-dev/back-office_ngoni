      ...
      <div className='flex justify-center items-center bs-full bg-backgroundPaper !min-is-full p-6 md:!min-is-[unset] md:p-12 md:is-[480px]'>
        ...
        <div className='flex flex-col gap-6 is-full sm:is-auto md:is-full sm:max-is-[400px] md:max-is-[unset] mbs-8 sm:mbs-11 md:mbs-0'>
          <div className='flex flex-col gap-1'>
            ...
            <Typography>
              {sent ? 'Si un compte existe avec cet email, un lien a été envoyé.' : 'Entrez votre email pour recevoir le lien de réinitialisation.'}
            </Typography>
          </div>
          <form noValidate autoComplete='off' onSubmit={handleSubmit} className='flex flex-col gap-6'>
            <CustomTextField
              ...
              disabled={sent}
            />
            <Button fullWidth variant='contained' type='submit' disabled={loading || sent}>
              {loading ? 'Envoi...' : sent ? 'Envoyé' : 'Envoyer le lien'}
            </Button>
